...
├── config/
│   ├── config.php          # Configuration file (generated by setup)
│   └── .installed          # Marker file indicating setup is complete
├── database/
...
Access the application in your browser. You'll be automatically redirected to the setup wizard, which will:
